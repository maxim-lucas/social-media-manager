...
| `04-community/` | 50 | The **recruiting** pack — 14 bilingual carousel posts, 5 story pairs, the bilingual language notice, 2 carousel dividers and 8 Highlight covers. Its own folder, renderer and 20-day run |

Total: 38 launch + 20 teaser + 38 evergreen + 50 community = 146 assets.
